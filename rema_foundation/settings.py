"""
Django settings for rema_foundation project.
...
SECRET_KEY = 'django-insecure-8#&d%%&#p!4d@z#_jxwudn@*rcqyn@*o3&niff5h#=7(p1s)h!'
...
ROOT_URLCONF = 'rema_foundation.urls'
...
WSGI_APPLICATION = 'rema_foundation.wsgi.application'
